...
export const getWeatherData = async (city) => {
  try {
    ...
    const API_KEY = process.env.REACT_APP_API_GEOCODING_KEY; // Usando a variável de ambiente
    ...
    const weatherResponse = await axios.get(`weather?key=${process.env.REACT_APP_WEATHER_API_KEY}&lat=${lat}&lon=${lon}&user_ip=remote`);
