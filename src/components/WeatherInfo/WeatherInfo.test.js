...
describe('WeatherInfo', () => {
    const mockWeatherData = {
        ...
        forecast: [
            { date: '15/04', max: 30, min: 20, description: 'Tempo limpo', rain_probability: 5 }, 
            { date: '16/04', max: 28, min: 18, description: 'Parcialmente nublado', rain_probability: 10 },
            { date: '17/04', max: 26, min: 16, description: 'Chuva', rain_probability: 20 }, 
            { date: '18/04', max: 27, min: 17, description: 'Sol', rain_probability: 15 }, 
            { date: '19/04', max: 29, min: 19, description: 'Nublado', rain_probability: 25 }, 
        ],
        moonPhase: 'full',
    };
    ...
    it('renders weather information correctly', () => {
        ...
        expect(screen.getByText(/Probabilidade de Chuva: 10%/i)).toBeInTheDocument(); 
